...
public class JPMTest extends TestCase {
	...
	//
	// static File cwd = new
	// File(System.getProperty("user.dir")).getAbsoluteFile();
	//
	...
	//
	// @Override
	// public String createCommand(CommandData data, Map<String,String> map,
	// boolean force, String... strings)
	// throws Exception {
	// return null;
	// }
	//
	// @Override
	// public String createService(ServiceData data, Map<String,String> map,
	// boolean force, String... strings)
	// throws Exception {
	// return null;
	// }
	...
	// * JustAnotherPackageManager jpm = new
	// JustAnotherPackageManager(reporter);
	// * jpm.setLibrary(new URI("http://localhost:8080/rest")); ArtifactData
	// * artifact = jpm.getCandidate("aQute.libg", true);
	...
	// * File("/tmp/cache")); } public void test_userMode_local_noConfig()
	// throws
	...
	// * String[] args = {"-s", "/tmp/settings","-u"}; Main main = new
	// Main(mock);
	...
	// * File("/tmp/globalCache")); } public void test_userMode_runconfig()
	// throws
	// * Exception { JustAnotherPackageManager mock =
	...
	// * verify(mock).setHomeDir(Platform.getPlatform(main).getLocal()); }
	// public
	// * void test_userMode_default() throws Exception {
	...
	// * that service.jar is in the local repo (Junit cannot retrieve it from
	// jar)
	...
	// JustAnotherPackageManager jpm = new JustAnotherPackageManager(new
	// ReporterAdapter(), null, home, bin);
