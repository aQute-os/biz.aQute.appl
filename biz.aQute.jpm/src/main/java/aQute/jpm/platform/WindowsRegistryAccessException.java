 ...
 * @author Shane Isbell
 */
public class WindowsRegistryAccessException extends Exception {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructs an <code>WindowsRegistryAccessException</code> with no
	 * exception message.
	 */
	...
	/**
	 * Constructs an <code>WindowsRegistryAccessException</code> with the
	...
	/**
	 * Constructs an <code>WindowsRegistryAccessException</code> with the cause
	 * of the exception.
	 *
	 * @param cause the cause of the exception
	 */
